...
from .views import client, voiture, employee
...
urlpatterns = [
    ...
    path('client/<int:pk>',
          login_required(DetailView.as_view(model=Client, template_name="client/client_detail.html")), name="client_detail"),
    ...
    path('employee/<int:pk>',
          login_required(DetailView.as_view(model=Employee, template_name="employee/employee_details.html")), name="employee_details"),
